...
permalink: expectation-and-tips-latn-101-f22
parent: LATN 101 - F22
nav_order: 2
---
***
...
This course is CBL (community-based learning) designate class. As such, outreach and community engagement are a required part of the course. This part of the course will be realized by having you mentor and engage in collaborative projects about the texts we are reading in class with elementary and middle schoolers in Worcester and Marlborough (NB: we have already developed a curriculum for you to use). This will start after Fall Break and you should anticipate spending roughly two hours per week (inclusive of travel) from that point forward in the semester. Please note that all the scheduling for this will be done in conjunction with the CBL office. 
